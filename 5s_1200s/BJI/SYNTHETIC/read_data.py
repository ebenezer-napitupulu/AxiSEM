...
obs = obspy.read("BJI_full.MSEED")       #change file name of file.MSEED

#####################################figure 1######################################
plt.figure(1)                        
fig = plt.figure(1)
fig.suptitle('BJI', fontsize=14)    #change the title of the each figure
...
plt.savefig('BJI sintetik and obervasi', format='png', dpi=1200)

###################################figure 2########################################
plt.figure(2)                       
fig2 = plt.figure(2)
fig2.suptitle("BJI", fontsize=14)
...
vel_obs.legend()
#------------------------------------save figure---------------------------
plt.savefig('BJI Filtered 0.3Hz-1000s', format='png', dpi=1200)

#####################################figure 3######################################
plt.figure(3)
fig3 = plt.figure(3)
fig3.suptitle("BJI", fontsize=14)
...
#------------------------------------save figure---------------------------
plt.savefig('BJI Filtered 0.3Hz-70s', format='png', dpi=1200)

#####################################figure 4######################################
plt.figure(4)
fig4 = plt.figure(4)
fig4.suptitle("BJI", fontsize=14)
...
#------------------------------save figure---------------------------------
plt.savefig('BJI Filtered 0.3Hz-70s Merged', format='png', dpi=1200)
plt.show()
