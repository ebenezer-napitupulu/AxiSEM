...
obs = obspy.read("JCJI_full.MSEED")       #change file name of file.MSEED

#####################################figure 1######################################
plt.figure(1)                        
fig = plt.figure(1)
fig.suptitle('JCJI', fontsize=14)    #change the title of the each figure
...
plt.figure(2)                       
fig2 = plt.figure(2)
fig2.suptitle("JCJI", fontsize=14)
...
vel_obs.legend()
#------------------------------------save figure---------------------------
#plt.savefig('JCJI Filtered 0.3Hz-1000s', format='png', dpi=1200)

#####################################figure 3######################################
plt.figure(3)
fig3 = plt.figure(3)
fig3.suptitle("JCJI", fontsize=14)
...
#------------------------------------save figure---------------------------
plt.savefig('JCJI Filtered 0.3Hz-150s', format='png', dpi=1200)
...
#------------------------------save figure---------------------------------
plt.savefig('JCJI Filtered 0.3Hz-150s Merged', format='png', dpi=1200)
plt.show()
