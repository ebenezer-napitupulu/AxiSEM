...
#open the y series
read_disp = open ('KMMI_Velocity.ascii','r')   #ganti dengan file yang dihasilkan dari raw2ascii.py
...
#set the variable
header = 'TIMESERIES'
station_name = 'INATEWS_KMMI_OBS_Z_R,'   #Net_Sta_Loc_Chan_Qual
samples = time_len-1
...
concatenate = open ('KMMI_full.ascii','a+')
