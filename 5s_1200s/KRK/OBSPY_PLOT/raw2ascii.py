...
##############################################################################
raw_data = open('KRK.DAT','r')     #ganti nama file sesuai stasiun yang dijalankan
...
raw_data = open('KRK.DAT','r')

for i in raw_data:
    write_ascii = open('KRK_Velocity.ascii','a+')   #ganti nama file yang akan dihasilkan
