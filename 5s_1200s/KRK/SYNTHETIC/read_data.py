...
obs = obspy.read("KRK_full.MSEED")       #change file name of file.MSEED

#####################################figure 1######################################
plt.figure(1)                        
fig = plt.figure(1)
fig.suptitle('KRK', fontsize=14)    #change the title of the each figure
...
vel_obs.legend()
#--------------------------------save figure-------------------------------
#plt.savefig('sintetik_KRK', format='png', dpi=1200)
plt.savefig('KRK sintetik and obervasi', format='png', dpi=1200)

###################################figure 2########################################
plt.figure(2)                       
fig2 = plt.figure(2)
fig2.suptitle("KRK", fontsize=14)
...
vel_obs.legend()
#------------------------------------save figure---------------------------
plt.savefig('KRK Filtered 0.3Hz-1000s', format='png', dpi=1200)

#####################################figure 3######################################
plt.figure(3)
fig3 = plt.figure(3)
fig3.suptitle("KRK", fontsize=14)
...
plt.xlim(15,165)
#plt.ylim(-15E-03,15E-03)         
vel_obs.legend()

#------------------------------------save figure---------------------------
plt.savefig('KRK Filtered 0.3Hz-150s', format='png', dpi=1200)

#####################################figure 4######################################
plt.figure(4)
fig4 = plt.figure(4)
fig4.suptitle("KRK", fontsize=14)
...
vel_obs.set_xlim(15,165)
vel_obs.set_ylim(-8E+06,8E+06)
...
vel_.set_xlim(0,150)
vel_.set_ylim(-2.5E-03,2.5E-03)
vel_.legend()

#------------------------------save figure---------------------------------
plt.savefig('KRK Filtered 0.3Hz-150s Merged', format='png', dpi=1200)
plt.show()
