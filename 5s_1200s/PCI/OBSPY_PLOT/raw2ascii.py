...
##############################################################################
raw_data = open('PCI.DAT','r')     #ganti nama file sesuai stasiun yang dijalankan
...
raw_data = open('PCI.DAT','r')

for i in raw_data:
    write_ascii = open('PCI_Velocity.ascii','a+')   #ganti nama file yang akan dihasilkan
