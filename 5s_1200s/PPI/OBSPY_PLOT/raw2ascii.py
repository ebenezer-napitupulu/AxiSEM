...
##############################################################################
raw_data = open('PPI.DAT','r')     #ganti nama file sesuai stasiun yang dijalankan
...
raw_data = open('PPI.DAT','r')

for i in raw_data:
    write_ascii = open('PPI_Velocity.ascii','a+')   #ganti nama file yang akan dihasilkan
