...
##############################################################################
raw_data = open('TARA.DAT','r')     #ganti nama file sesuai stasiun yang dijalankan
...
raw_data = open('TARA.DAT','r')

for i in raw_data:
    write_ascii = open('TARA_Velocity.ascii','a+')   #ganti nama file yang akan dihasilkan
