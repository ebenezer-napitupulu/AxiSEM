...
#open the y series
read_disp = open ('TNG_Velocity.ascii','r')   #ganti dengan file yang dihasilkan dari raw2ascii.py
...
#set the variable
header = 'TIMESERIES'
station_name = 'INATEWS_TNG_OBS_Z_R,'   #Net_Sta_Loc_Chan_Qual
samples = time_len-1
...
concatenate = open ('TNG_full.ascii','a+')
