...
##############################################################################
raw_data = open('TNG.DAT','r')     #ganti nama file sesuai stasiun yang dijalankan
...
raw_data = open('TNG.DAT','r')

for i in raw_data:
    write_ascii = open('TNG_Velocity.ascii','a+')   #ganti nama file yang akan dihasilkan
