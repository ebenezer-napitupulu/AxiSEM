...
##############################################################################
raw_data = open('WSI.DAT','r')     #ganti nama file sesuai stasiun yang dijalankan
...
raw_data = open('WSI.DAT','r')

for i in raw_data:
    write_ascii = open('WSI_Velocity.ascii','a+')   #ganti nama file yang akan dihasilkan
