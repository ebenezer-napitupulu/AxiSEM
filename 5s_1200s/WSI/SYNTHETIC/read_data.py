...
vel_obs.legend()
#--------------------------------save figure-------------------------------
#plt.savefig('sintetik_WSI', format='png', dpi=1200)
plt.savefig('WSI sintetik and obervasi', format='png', dpi=1200)

###################################figure 2########################################
plt.figure(2)                       
fig2 = plt.figure(2)
fig2.suptitle("WSI", fontsize=14)
...
vel_obs.legend()
#------------------------------------save figure---------------------------
plt.savefig('WSI Filtered 0.3Hz-1000s', format='png', dpi=1200)

#####################################figure 3######################################
plt.figure(3)
fig3 = plt.figure(3)
fig3.suptitle("WSI", fontsize=14)
...
#------------------------------------save figure---------------------------
plt.savefig('WSI Filtered 0.3Hz-150s', format='png', dpi=1200)

#####################################figure 4######################################
plt.figure(4)
fig4 = plt.figure(4)
fig4.suptitle("WSI", fontsize=14)
...
vel_obs.set_xlim(0,500)
vel_obs.set_ylim(-2.5E+05,2.5E+05)
...
vel_.set_xlim(0,500)
vel_.set_ylim(-0.8E-03,0.8E-03)
vel_.legend()

#------------------------------save figure---------------------------------
plt.savefig('WSI Filtered 0.3Hz-150s Merged', format='png', dpi=1200)
plt.show()
