...
'''
#salin data mentah pada folder sebelum menjalankan program ini
##############################################################################
from obspy import UTCDateTime #as utc
#from obspy import read

##############################################################################
raw_data = open('YOGI.DAT','r')     #ganti nama file sesuai stasiun yang dijalankan
...
raw_data = open('YOGI.DAT','r')

for i in raw_data:
    write_ascii = open('YOGI_Velocity.ascii','a+')   #ganti nama file yang akan dihasilkan
...
##############################################################################
#setelah menjalankan program ini, kemudian jalankan program concatenate.py